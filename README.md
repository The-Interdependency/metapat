...
The installed package includes `fixtures/root-spine-envelope-v3.json`, which must remain byte-identical to the live canonical constructor.
...
The packaged `fixtures/semantic-module-catalog-v3.json` must remain byte-identical to the live constructor plus one trailing newline. See `docs/semantic-module-catalog.md`.
...
The packaged fixture is `fixtures/quantum-magnetism-application-v3.json`. See `docs/application-modules.md` and `docs/applications/quantum-magnetism.md`.
