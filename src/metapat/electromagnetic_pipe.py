...
PIPE_APPLICATION_VERSION = "three-phase-electromagnetic-pipe-application-v3"
...
PIPE_BINDING_SPECS = (
    ...
    ("metapat.axiom.3.state", "energy-state", "Phase-current, magnetic-field, magnetization, motion, eddy-current, and thermal conditions are distinct state surfaces."),
    ...
    ("metapat.axiom.9.scalar", "gradient", "Readable differences include field amplitude, field phase, position, temperature, magnetization, force, leakage, and shielding response."),
