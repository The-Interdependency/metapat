...
def test_01_boundary_earns_its_keep() -> None:
...
def test_02_tensor_precedes_time() -> None:
...
def test_03_registration_is_not_time() -> None:
    sequence = ({"t": 0}, {"t": 1})
...
def test_04_observer_role_by_registration() -> None:
    sequence = ({"t": 0}, {"t": 1})
...
def test_05_consciousness_is_optional() -> None:
